...
| `controllerArgs.reSyncPeriod` | The period for resync the applications                                                        | `2m`      |
...
| `optimize.informerCache`                          | if enabled, informer cache will be optimized by removing unnecessary fields will be filtered                                                                                                                                     | `false` |
| `optimize.applicationRevisionDefinitionStorage`   | if enabled, application revision definition cache will be optimized by using reducing duplicated definition storage                                                                                                              | `false` |
...
| `kubeClient.qps`              | The qps for reconcile clients, default is 100                                                                                                                      | `200`                |
| `kubeClient.burst`            | The burst for reconcile clients, default is 200                                                                                                                    | `300`                |
