...
var _ = Describe("Testing dry-run", func() {
	...
	It("Testing dry-run", func() {
		...
		Expect(cli.Create(context.TODO(), &wwd)).Should(BeNil())
		...
		Expect(cli.Create(context.TODO(), &td)).Should(BeNil())
	...
	It("Testing dry-run with policy", func() {
		...
		Expect(cli.Create(context.TODO(), &wfsd)).Should(BeNil())
	...
	It("Testing dry-run with ref workflow", func() {
		...
		Expect(cli.Create(context.TODO(), &p)).Should(BeNil())
		...
		Expect(cli.Create(context.TODO(), &wf)).Should(BeNil())
