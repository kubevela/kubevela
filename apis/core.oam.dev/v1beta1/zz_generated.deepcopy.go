...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationRevisionAppfileCache) DeepCopyInto(out *ApplicationRevisionAppfileCache) {
	*out = *in
	if in.Policies != nil {
	...
	if in.ExternalWorkflow != nil {
		in, out := &in.ExternalWorkflow, &out.ExternalWorkflow
		*out = new(runtime.RawExtension)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationRevisionAppfileCache.
func (in *ApplicationRevisionAppfileCache) DeepCopy() *ApplicationRevisionAppfileCache {
	if in == nil {
		return nil
	}
	out := new(ApplicationRevisionAppfileCache)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ApplicationRevisionSpec) DeepCopyInto(out *ApplicationRevisionSpec) {
	*out = *in
	...
	if in.AppfileCache != nil {
		in, out := &in.AppfileCache, &out.AppfileCache
		*out = new(ApplicationRevisionAppfileCache)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationRevisionWorkflowStatus) DeepCopyInto(out *ApplicationRevisionWorkflowStatus) {
	*out = *in
	if in.StartTime != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationRevisionWorkflowStatus.
func (in *ApplicationRevisionWorkflowStatus) DeepCopy() *ApplicationRevisionWorkflowStatus {
	if in == nil {
		return nil
	}
	out := new(ApplicationRevisionWorkflowStatus)
	in.DeepCopyInto(out)
	return out
}
