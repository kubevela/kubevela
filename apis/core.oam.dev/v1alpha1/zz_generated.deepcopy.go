...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationDecision) DeepCopyInto(out *ReplicationDecision) {
	*out = *in
	if in.Keys != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicationDecision.
func (in *ReplicationDecision) DeepCopy() *ReplicationDecision {
	if in == nil {
		return nil
	}
	out := new(ReplicationDecision)
	in.DeepCopyInto(out)
	return out
}
