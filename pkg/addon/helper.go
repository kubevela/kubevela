...
func EnableAddon(ctx context.Context, name string, version string, cli client.Client, apply apply.Applicator, config *rest.Config, r Registry, args map[string]interface{}, cache *Cache, registries []Registry, opts ...InstallOption) (string, error) {
	h := NewAddonInstaller(ctx, cli, common.DiscoveryClient(), apply, config, &r, args, cache, registries, opts...)
...
func EnableAddonByLocalDir(ctx context.Context, name string, dir string, cli client.Client, applicator apply.Applicator, config *rest.Config, args map[string]interface{}, opts ...InstallOption) (string, error) {
	...
	h := NewAddonInstaller(ctx, cli, common.DiscoveryClient(), applicator, config, &Registry{Name: LocalAddonRegistryName}, args, nil, nil, opts...)
