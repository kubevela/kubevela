...
const (
	...
	// CompressResourceTracker enable the compression for ResourceTracker. It can be useful if you have large application
	// that needs to dispatch lots of resources or large resources (like CRD or huge ConfigMap), which at the cost of
	// slower processing speed due to the extra overhead for compression and decompression
	CompressResourceTracker featuregate.Feature = "CompressResourceTracker"
)
...
var defaultFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	CompressResourceTracker:       {Default: false, PreRelease: featuregate.Alpha},
}
