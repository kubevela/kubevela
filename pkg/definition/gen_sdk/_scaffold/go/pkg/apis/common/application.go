...
type ApplicationBuilder struct {
	...
	steps        []WorkflowStep
	policies     []Policy
	workflowMode v1alpha1.WorkflowExecuteMode
}
...
func (a *ApplicationBuilder) SetWorkflowMode(steps, subSteps v1alpha1.WorkflowMode) TypedApplication {
...
func (a *ApplicationBuilder) Build() v1beta1.Application {
	...
	steps := make([]v1alpha1.WorkflowStep, 0, len(a.steps))
...
func FromWorkflowStep(step v1alpha1.WorkflowStep) (WorkflowStep, error) {
