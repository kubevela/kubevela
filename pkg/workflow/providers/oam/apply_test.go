...
func TestRenderComponent(t *testing.T) {
	r := require.New(t)
	p := &provider{
		render: func(comp common.ApplicationComponent, patcher *value.Value, _, _, _, _ string) (*unstructured.Unstructured, []*unstructured.Unstructured, error) {
...
func simpleComponentApplyForTest(comp common.ApplicationComponent, _ *value.Value, _, _, _, _ string) (*unstructured.Unstructured, []*unstructured.Unstructured, bool, error) {
