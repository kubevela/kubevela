...
var _ = Describe("Helm Workflow Provider", func() {

	Describe("ProviderName", func() {
		It("should be 'helm'", func() {
			Expect(ProviderName).To(Equal("helm"))
		})
	})

	Describe("GetTemplate", func() {
		It("should return a non-empty CUE template", func() {
			tmpl := GetTemplate()
