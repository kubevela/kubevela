...
func buildResourceItem(res querytypes.AppliedResource, workload querytypes.Workload, object unstructured.Unstructured,
	addInfo map[string]interface{}) querytypes.ResourceItem {
