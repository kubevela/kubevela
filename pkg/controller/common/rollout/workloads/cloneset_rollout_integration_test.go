...
var _ = Describe("cloneset controller", func() {
	...
	BeforeEach(func() {
		...
		name = "rollout1"
		appRollout := v1beta1.AppRollout{TypeMeta: metav1.TypeMeta{APIVersion: v1beta1.SchemeGroupVersion.String(), Kind: v1beta1.ApplicationKind}, ObjectMeta: metav1.ObjectMeta{Name: name}}
