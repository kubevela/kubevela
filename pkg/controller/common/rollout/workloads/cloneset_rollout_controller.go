...
func (c *cloneSetRolloutHandler) initialize(cloneSet *kruise.CloneSet) {
...
func (c *cloneSetRolloutHandler) rolloutOneBatchPods(cloneSet *kruise.CloneSet, newPodTarget int) {
...
func (c *cloneSetRolloutHandler) verifySpec(rolloutSpec *v1alpha1.RolloutPlan, cloneSet *kruise.CloneSet) error {
	...
	return VerifySumOfBatchSizes(rolloutSpec, *cloneSetSize)
}
