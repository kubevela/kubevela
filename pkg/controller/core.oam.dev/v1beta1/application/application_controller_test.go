...
var _ = Describe("Test Application Controller", func() {
	...
	It("application with dag workflow failed after retries", func() {
		featuregatetesting.SetFeatureGateDuringTest(&testing.T{}, utilfeature.DefaultFeatureGate, wffeatures.EnableSuspendOnFailure, true)
		ns := corev1.Namespace{
			ObjectMeta: metav1.ObjectMeta{
	...
	It("test application with healthy and PreDispatch trait", func() {
		featuregatetesting.SetFeatureGateDuringTest(&testing.T{}, utilfeature.DefaultFeatureGate, features.MultiStageComponentApply, true)
