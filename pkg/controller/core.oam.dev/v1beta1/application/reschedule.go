...
func RescheduleAppRevAndRT(ctx context.Context, cli client.Client, app *v1beta1.Application, shardID string) error {
	...
	err = cli.List(ctx, appRevisionList, client.InNamespace(app.Namespace), client.MatchingLabels{oam.LabelAppName: app.Name})
	if err != nil {
		return err
	}
	...
	objs = append(objs, slices.Map(appRevisionList.Items, func(r v1beta1.ApplicationRevision) client.Object { return r.DeepCopy() })...)
