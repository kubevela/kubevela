	...
	ding: builtin.#Steps & {
		if parameter.dingding != _|_ {
			...
			if parameter.dingding.url.secretRef != _|_ && parameter.dingding.url.value == _|_ {
				...
				stringValue: utils.#ConvertString & {$params: bt: base64.Decode(null, read.$returns.value.data[parameter.dingding.url.secretRef.key])}
				ding2:       http.#Do & {
					$params: {
						method: "POST"
	...
	lark: utils.#Steps & {
		if parameter.lark != _|_ {
			...
			if parameter.lark.url.secretRef != _|_ && parameter.lark.url.value == _|_ {
				...
				stringValue: utils.#ConvertString & {$params: bt: base64.Decode(null, read.$returns.value.data[parameter.lark.url.secretRef.key])}
				lark2:       http.#Do & {
					$params: {
						method: "POST"
						url:    stringValue.$returns.str
	...
	slack: utils.#Steps & {
		if parameter.slack != _|_ {
			...
			if parameter.slack.url.secretRef != _|_ && parameter.slack.url.value == _|_ {
				...
				stringValue: utils.#ConvertString & {$params: bt: base64.Decode(null, read.$returns.value.data[parameter.slack.url.secretRef.key])}
				slack2:      http.#Do & {
					$params: {
						method: "POST"
						url:    stringValue.$returns.str
	...
	email0: utils.#Steps & {
		if parameter.email != _|_ {
			...
			if parameter.email.from.password.secretRef != _|_ && parameter.email.from.password.value == _|_ {
				...
				stringValue: utils.#ConvertString & {$params: bt: base64.Decode(null, read.$returns.value.data[parameter.email.from.password.secretRef.key])}
