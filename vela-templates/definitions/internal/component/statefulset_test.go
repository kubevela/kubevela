...
func TestStatefulSet(t *testing.T) {
	...
	txtarData, err := os.ReadFile("testdata/statefulset.txtar")
	if err != nil {
		t.Fatalf("failed to read testdata/statefulset.txtar: %v", err)
	}
	...
	// Validate that actual output matches expected output using CUE subsumption
