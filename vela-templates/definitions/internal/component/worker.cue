...
template: {
	...
	parameter: {
		...
		env?: [...{
			...
			valueFrom?: {
				// +usage=The Pod-level fields into the running container as environment variables.
				fieldRef?: {
					// +usage=The filedPath of the Pod-level fields
					fieldPath: string
				}
				// +usage=The Container-level fields into the running container as environment variables.
				resourceFieldRef?: {
					// +usage=The container name
					containerName: string
					// +usage=The resource name of container
					resource:      string
				}
