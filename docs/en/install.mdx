...
If you have used helm to install an old version of vela. This installation step can help you upgrade to the new version kubevela chart.

First you need to add some new crds and upgrade several crds version to v1beta1.
...
Then use helm to update the kubevela chart.

```
helm upgrade --install --create-namespace --namespace vela-system  kubevela kubevela/vela-core --version 1.0.0-rc2
```