...
e2e-setup:
	helm upgrade --install --create-namespace --set image.pullPolicy=IfNotPresent --set image.repository=vela-core-test --set image.tag=$(GIT_COMMIT) -n vela-system kubevela ./charts/vela-core
	ginkgo version
