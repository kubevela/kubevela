...
// Package controllers_test contains E2E tests for the CRD-based config management system.
//
// PREREQUISITE: The KubeVela controller must be deployed and the two new CRDs installed:
//
//	config.oam.dev_configtemplates.yaml
//	config.oam.dev_configs.yaml
//
// These CRDs are generated by `make manifests` and installed by the Helm chart.
...
const (
	...
	// Simple CUE template: accepts a username, emits a Secret with stringData.
