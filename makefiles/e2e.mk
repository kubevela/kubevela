...
e2e-setup:
	...
	helm upgrade --install --namespace vela-system --set image.tag=$(GIT_COMMIT) --wait oam-rollout --set image.repository=vela-runtime-rollout-test --set image.tag=$(GIT_COMMIT) ./runtime/rollout/charts
